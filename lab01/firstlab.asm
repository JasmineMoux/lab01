...
main:   # Words ending with ':' are **labels**
        ...
        la $a1,matric               #la  $a0, mesg1        # get address of mesg1 into $a0
        lw $v0,0($a1)
        ...
        #lab01_tester.pylab01_tester.pylab01_tester.py
...
###############################################################################
        ...
        #  
matric: .word 2761   # This will be used by your submitted code
